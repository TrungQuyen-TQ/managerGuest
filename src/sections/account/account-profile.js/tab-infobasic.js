...
import { setErrorsAccountAsync, setInputAccountsAsync, setTouchedAccountAsync } from "src/slices/account/account";
...
export function validateFieldInfobasic(dispatch, tab, fieldName, fieldValue) {
  const validationSchema = Yup.object().shape({
    ...
    accountType: Yup.string().max(4000).required("Vui lòng nhập thông tin vào trường này"),
    email: Yup.string()
      .max(4000)
        ...
        <Grid2 item size={{ xs: 12, md: 6, sm: 12 }}>
          ...
          >
            ...
            <Grid2 container spacing={2} style={{ marginTop: "20px", marginBottom: "10px" }}>
              ...
              <Grid2 item size={4} sx={{ marginTop: "-13px" }}>
            ...
            <Autocomplete
              ...
              onChange={(event, newValue) => handleChangeSelect(event, "accountType", newValue)}
              value={accountType}
              name="accountType"
              fullWidth
              size="small"
